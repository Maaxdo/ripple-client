    ...
    <section>
      ...
      >
        <div className={"w-full lg:w-1/2 space-y-6 lg:space-y-8"}>
          ...
          >
            one stop for <br />
            your <span className={"text-[#FF78E6]"}>digital</span> <br />
            <span className={"text-[#C7FFFD]"}>resources</span>
          </h1>
          <p
            className={
          ...
          >
            Purchase digital products, and resource created and curated by
            Ripple.
          </p>
          <div className={"flex justify-center lg:justify-start"}>
            <Button asChild size={"lg"} variant={"secondary"}>
              <Link href={"#courses"}>See items</Link>
            </Button>
          </div>
        </div>
        <div className={"w-full lg:w-1/2 flex justify-center"}>
          <Image
            ...
            width={670}
            height={550}
            className={"w-9/12 lg:w-11/12 object-cover"}
          />
        </div>
      </Container>
    </section>
