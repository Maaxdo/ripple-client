...
export const Newsletter: FC = () => {
  ...
  return (
    <div className={"my-3 bg-black py-12 relative rounded-3xl"}>
      <Image
      ...
      <div className={"max-w-sm mx-auto text-center space-y-6"}>
        <h2
          className={`${madeSoulmaze.className} text-white text-lg md:text-xl lg:text-2xl xl:text-3xl uppercase`}
        >
